...
<html lang="en">
  ...
  $get_pro = "select * from paslaugos";
    ...
    while($row_pro=mysqli_fetch_array($run_pro)){
        ...
        $pro_kate = $row_pro['paslaug_kate'];
        $pro_pavad = $row_pro['paslaug_pavad'];
        $pro_marke = $row_pro['paslaug_marke'];
        ...
        <div class='card card-cascade narrower'>
            ...
            <div class='view overlay hm-white-slight'>
                ...
                <div class='card-body'>
                 ...
                 <h4><a href='details.php?pro_id=$pro_id'>$pro_pavad</a></h4>

                    <h6 class='card-title'>$pro_kaina €</h6>
                    <a href='index.php?add_cart=$pro_id'class='btn btn-unique'>Užsisakyti</a>
                </div>
